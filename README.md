...
- Fixed manual page translation so it no longer survives a full page reload.
- Fixed context menu registration errors caused by duplicate or missing menu items.
